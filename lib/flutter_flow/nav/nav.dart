...
GoRouter createRouter(AppStateNotifier appStateNotifier, [Widget? entryPage]) =>
    GoRouter(
      ...
      errorBuilder: (context, state) => appStateNotifier.loggedIn
          ? entryPage ?? const ProductListingPageWidget()
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => const ProductListingPageWidget(),
        ),
        FFRoute(
          name: 'categoryPage',
          path: '/categoryPage',
          builder: (context, params) => CategoryPageWidget(
            categoryData: params.getParam(
              'categoryData',
              ParamType.JSON,
            ),
          ),
        ...
        FFRoute(
          name: 'Gmap',
          path: '/gmap',
          builder: (context, params) => const GmapWidget(),
        )
